...
class Ui_MainWindow(object):
    ...
    def setPhoto(self, image):
        try:
            ...
            print("Resim Değiştirilirken Hata Oluştu.")
    ...
    def definePlate(self, image):
        ...
        try:
            ...
            # ROI (kırpma işlemi)
            correctPlate = halfImage[x_min:x_max, y_min:y_max]


            # Resimden plaka okuma
            results = reader.readtext(correctPlate,decoder="beamsearch",blocklist=" ",allowlist="ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789")

            #results = pytesseract.image_to_string(correctPlate,config='--psm 11',lang='eng',timeout=5)
            ...
            print("Plakayı okurken hata oluştu")
